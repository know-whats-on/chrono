...
export const PUSH_CATEGORIES = [
  ...
  { key: "invoice_change_requested", label: "Changes Requested", desc: "When a client requests changes" },
  { key: "invoice_invalidated", label: "Invoice Invalidated", desc: "When a signature is voided due to changes" },
] as const;
...
export const DEFAULT_PREFERENCES: Record<string, boolean> = {
  ...
  invoice_change_requested: true,
  invoice_invalidated: true,
};