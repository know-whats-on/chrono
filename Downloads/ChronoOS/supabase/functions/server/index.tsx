      ...
      for (const session of sessions) {
        ...
        for (const slot of slots) {
          ...
          if (diffMins > 0 && diffMins <= 5) {
            ...
            if (diffMins <= 4) {
              const waitlisted = allBookings.filter((b:any) => b.slot_id === slot.id && b.status === "waitlist");
            ...
            if (diffMins <= 5) {
              const confirmed = allBookings.filter((b:any) => b.slot_id === slot.id && b.status === "confirmed");
