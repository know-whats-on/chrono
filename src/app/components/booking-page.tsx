...
export function BookingPage({ code: propCode, defaultName }: { code?: string; defaultName?: string }) {
  ...
  const renderTzSelector = () => (
    <div className="relative mt-3 mb-1">
      ...
      {showTzPicker && (
        <div className="absolute top-full left-0 mt-1 z-50 bg-white rounded-xl shadow-xl border border-slate-200 w-72 max-h-64 overflow-hidden flex flex-col">
  ...
  if (loading) {
    return (
      <div className="min-h-dvh flex items-center justify-center" style={{ background: "linear-gradient(135deg, #f8c0d8, #d8b4fe, #93c5fd, #99f6e4)" }}>
