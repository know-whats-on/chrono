  ...
  return (
    ...
    >
      <div className="flex items-start gap-2.5">
        ...
        {/* Edit + Delete */}
        <div className="flex items-center gap-0.5 shrink-0 opacity-60 md:opacity-0 md:group-hover:opacity-100 transition">
          {onEdit && !item.completed && (
            <button
              onClick={startEdit}
              className="mt-0.5 p-1 rounded hover:bg-muted text-muted-foreground hover:text-primary transition"
              title="Edit item"
            >
          ...
          <button
            onClick={onDelete}
            className="mt-0.5 p-1 rounded hover:bg-destructive/10 text-muted-foreground hover:text-destructive transition"
          >
