...
export function HomePage() {
  ...
  return (
    <div className="max-w-lg mx-auto px-3 sm:px-4 py-5 sm:py-6 md:max-w-none md:px-6 lg:px-10 xl:px-14 md:py-4 lg:py-5 md:h-[calc(100dvh-56px-26px)] md:flex md:flex-col md:overflow-hidden">
      {/* ── Header ── */}
      <div className="relative z-[1] md:z-[60] flex flex-col items-center md:flex-row md:items-center md:justify-between mb-5 sm:mb-6 md:mb-4 shrink-0">
        ...
        <>
          ...
          <div className="space-y-5 md:hidden" style={{ overflowAnchor: 'none' as any }}>
            ...
            {layout.order.map((id) => {
              ...
              if (id === "timeline") {
                return (
                  <div key={id} className="relative z-[1] h-[320px] overflow-hidden rounded-2xl flex flex-col">
                    {widget}
                  </div>
                );
              }
          ...
          <div className={`hidden md:grid gap-3 lg:gap-4 flex-1 min-h-0 ${
            ...
            <div className="flex flex-col gap-3 lg:gap-4 min-h-0" style={{ overflow: "visible" }}>
              ...
              {!layout.hidden.includes("timeline") && (
                <div className="relative z-[1] flex-1 min-h-0 overflow-hidden rounded-2xl flex flex-col">
                  <UnifiedTimeline
                    events={events}
                    tasks={myLists}
                    reminders={reminders}
