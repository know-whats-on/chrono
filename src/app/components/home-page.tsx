...
import { getMyLists, getReminders, getDaysSince, getEvents, updateMe, queryAvailability, getRules, getWithPrefetch } from "../lib/api";
import {
...
export function HomePage() {
  ...
  const loadData = useCallback(async () => {
    try {
      ...
      const [ev, ml, r, ds] = await Promise.all([
