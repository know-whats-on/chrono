...
export const updateCalendarConnection = (id: string, updates: { color?: string; display_name?: string }) =>
  request(`/calendars/connections/${id}`, { method: "PATCH", body: JSON.stringify(updates) });
